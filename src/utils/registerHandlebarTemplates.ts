...
import functionIsArray from '../templates/core/functions/isArray.hbs';
import functionIsBlob from '../templates/core/functions/isBlob.hbs';
import functionIsBoolean from '../templates/core/functions/isBoolean.hbs';
import functionIsDefined from '../templates/core/functions/isDefined.hbs';
import functionIsFile from '../templates/core/functions/isFile.hbs';
import functionIsFormData from '../templates/core/functions/isFormData.hbs';
import functionIsNull from '../templates/core/functions/isNull.hbs';
import functionIsObject from '../templates/core/functions/isObject.hbs';
...
import functionIsUndefined from '../templates/core/functions/isUndefined.hbs';
...
export const registerHandlebarTemplates = (root: {
    ...
    Handlebars.registerPartial('functions/isArray', Handlebars.template(functionIsArray));
    Handlebars.registerPartial('functions/isBlob', Handlebars.template(functionIsBlob));
    Handlebars.registerPartial('functions/isBoolean', Handlebars.template(functionIsBoolean));
    Handlebars.registerPartial('functions/isDefined', Handlebars.template(functionIsDefined));
    Handlebars.registerPartial('functions/isFile', Handlebars.template(functionIsFile));
    Handlebars.registerPartial('functions/isFormData', Handlebars.template(functionIsFormData));
    Handlebars.registerPartial('functions/isNull', Handlebars.template(functionIsNull));
    Handlebars.registerPartial('functions/isObject', Handlebars.template(functionIsObject));
    Handlebars.registerPartial('functions/isUndefined', Handlebars.template(functionIsUndefined));
